...
-- question 0 (Union of Fact Internet sales and Fact internet sales new)
CREATE TEMPORARY TABLE Union_Table1 AS
...
-- question 1 (productname from the Product sheet to Sales)
SELECT s.ProductKey,
...
-- question 2 (Customerfullname from the Customer and Unit Price from Product sheet to Sales)
...
-- question 7 (table for month and sales )
